...
class ProductivityTools:
    ...
    def add_task(self, title: str, description: str, priority: str) -> str:
        ...
        try:
            ...
            return f"â�Œ Invalid priority '{priority}'. Please use one of: low, medium, high, urgent."
        except Exception as e:
            return f"â�Œ Error adding task: {e}"
    ...
    def add_productivity_goal(self, title: str, target_value: str, target_date_str: str) -> str:
        ...
        try:
            ...
            return "â�Œ Invalid date format. Please use YYYY-MM-DD."
        except Exception as e:
            return f"â�Œ Error adding goal: {e}"
