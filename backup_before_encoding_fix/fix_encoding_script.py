...
# -*- coding: utf-8 -*-
"""
💎 GEM OS - Unicode Encoding Fix Script
...
def main():
    ...
    print("💎 GEM OS - Unicode Encoding Fix Script")
    print("=" * 50)
    ...
    print(f"\n💾 Backups created in: {fixer.backup_dir.absolute()}")
...
def fix_common_unicode_issues(content: str) -> str:
    ...
    replacements = {
        ...
        '\x87': '💎',  # Replace invalid byte with gem emoji
...
# -*- coding: utf-8 -*-
"""
💎 GEM OS - Text-to-Speech Module (core/tts_module.py)
...
# -*- coding: utf-8 -*-
"""
💎 GEM OS - LLM Handler (core/llm_handler.py)
...
# -*- coding: utf-8 -*-
"""
💎 GEM OS - Config Manager Compatibility Layer (core/config_manager.py)
